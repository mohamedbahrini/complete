...
public class InterceptMethods {
    ...
    @Before(value = "com.training.complete.aop.Pointcuts.subscribeEvents()")
    public void interceptSubscribe(JoinPoint point) {
        LOGGER.info("interceptSubscribe {}", point.getTarget());
    }

    @AfterThrowing(value = "com.training.complete.aop.Pointcuts.repositoryErrorEvents()", throwing = "e")
